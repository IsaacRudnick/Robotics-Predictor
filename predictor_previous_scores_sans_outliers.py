    ...
    for outlier_percent in outlier_percents:
        ...
        for event_file in dir:
            ...
            for match_key in event_matches:
                ...
                average_blue_scores = sum([average_previous_scores(team, match_info["game_start_time"], outlier_percent) for team in blue_teams])/3 
                average_red_scores = sum([average_previous_scores(team, match_info["game_start_time"], outlier_percent) for team in red_teams])/3
